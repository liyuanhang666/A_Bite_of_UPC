        ...
        <div class="foodinfos">
          ...
          <div class="foodinfo">
            <div class="price" style="float:left;font-size:1.4rem;color:red"><i class="fa fa-jpy fa-1x" aria-hidden="true"
                style="color:red"></i><div class="pricep">{{favor.price}}</div></div>
            <span class="address"><i class="fa fa-map-marker fa-1x" aria-hidden="true" style="color:white"></i>{{favor.address}}</span>
            <span class="cancel" style="float:right" id="cancelfavor" @click="cancelfavor(favor.id)"><i class="fa fa-star fa-lg"
                aria-hidden="true" style="color:yellow"></i>取消收藏</span>
          </div>
        </div>
      </div>
    </div>
